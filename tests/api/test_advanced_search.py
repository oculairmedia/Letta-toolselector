...
def test_advanced_search():
    ...
    test_cases = [
        {"name": "Basic Query with Query Expansion", "query": "create a post", "params": {"limit": 3}},
        {
            "name": "Filter by Tags",
            "query": "list or display content",
            "params": {"limit": 3, "filter_tags": ["mcp:postiz", "mcp:ghost"]},
        },
        {"name": "Group by Source Type", "query": "manage content", "params": {"limit": 5, "group_by": "source_type"}},
        {
            "name": "Vector-Heavy Search (alpha=0.9)",
            "query": "tools for content management",
            "params": {"limit": 3, "alpha": 0.9},
        },
        {
            "name": "Keyword-Heavy Search (alpha=0.3)",
            "query": "tools for content management",
            "params": {"limit": 3, "alpha": 0.3},
        },
    ]
