...
def test_weaviate_graphql():
    ...
    try:
        ...
        if (
            ...
            and "Tool" in result["data"]["Get"]
            and len(result["data"]["Get"]["Tool"]) > 0
            and "_additional" in result["data"]["Get"]["Tool"][0]
            and "vector" in result["data"]["Get"]["Tool"][0]["_additional"]
        ):
...
def test_direct_openai():
    ...
    try:
        ...
        data = {"model": "text-embedding-3-small", "input": "search for jobs"}
