...
async def test_ollama_provider_config():
    ...
    try:
        ...
        graphiti_compatible = (
            ...
            and provider.dimensions == expected_dimensions
            and expected_host in provider.base_url
        )
...
def test_environment_variable_support():
    ...
    try:
        ...
        success = (
            ...
            and provider.model == "dengcao/Qwen3-Embedding-4B:Q4_K_M"
            and provider.dimensions == 2560
            and "192.168.50.80" in provider.base_url
        )
