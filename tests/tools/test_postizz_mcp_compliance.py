...
class MCPComplianceTester:
    ...
    def test_initialize(self) -> Dict[str, Any]:
        ...
        try:
            response = self.session.post(
                self.server_url, json=init_request, headers={"Content-Type": "application/json"}, timeout=10
            )
    ...
    def test_tools_list(self) -> Dict[str, Any]:
        ...
        try:
            response = self.session.post(
                self.server_url, json=tools_request, headers={"Content-Type": "application/json"}, timeout=10
            )
            results["no_session"] = {
                "status_code": response.status_code,
                "content_type": response.headers.get("Content-Type"),
    ...
    def analyze_compliance(self, init_results: Dict, tools_results: Dict) -> Dict[str, Any]:
        ...
        return {"compliance_score": compliance_score, "issues": issues, "fixes": fixes, "tools_found": tools_found}
    ...
    def run_full_test(self):
        ...
        return {"initialization": init_results, "tools_list": tools_results, "analysis": analysis}
