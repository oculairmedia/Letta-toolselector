...
def test_tool_enhancement():
    ...
    for i, case in enumerate(test_cases, 1):
        ...
        enhanced = prompter.enhance_tool_description(
            description=case["desc"], tool_name=case["name"], tool_type=case["type"], tool_source=case["source"]
        )
...
def test_convenience_functions():
    ...
    enhanced_tool = enhance_tool_for_embedding(tool_description=tool_desc, tool_name="Slack Bot", tool_type="mcp")
