...
class TestAgentServiceConfiguration:
    ...
    def test_configure_defaults(self, mock_http_session):
        ...
        agent_service.configure(http_session=mock_http_session, letta_url="http://test:8283")
...
class TestFetchAgentInfo:
    ...
    async def test_fetch_agent_info_success(self, test_agent_id, mock_http_session):
        ...
        agent_service.configure(
            http_session=mock_http_session, letta_url="http://test:8283", headers={"Authorization": "Bearer test"}
        )
    ...
    async def test_fetch_agent_info_returns_unknown_on_missing_name(self, test_agent_id, mock_http_session):
        ...
        agent_service.configure(http_session=mock_http_session, letta_url="http://test:8283", headers={})
...
class TestRegisterTool:
    ...
    async def test_register_tool_success(self, mock_http_session):
        ...
        mock_response = MagicMock()
        mock_response.status = 200
        mock_response.json = AsyncMock(return_value={"id": "tool-12345", "name": "test_tool"})
        mock_response.raise_for_status = Mock()
...
class TestSendTriggerMessage:
    ...
    async def test_send_trigger_message_success(self, test_agent_id, mock_http_session):
        ...
        mock_response = MagicMock()
        mock_response.status = 200
        mock_response.json = AsyncMock(return_value={"messages": [{"run_id": "run-12345"}]})
        ...
        result = await agent_service.send_trigger_message(test_agent_id, ["tool1", "tool2"], "test query")
    ...
    async def test_send_trigger_message_no_session(self, test_agent_id):
        ...
        result = await agent_service.send_trigger_message(test_agent_id, ["tool1"], None)
    ...
    async def test_send_trigger_message_truncates_tool_list(self, test_agent_id, mock_http_session):
        ...
        result = await agent_service.send_trigger_message(test_agent_id, tools, None)
...
class TestEmitMatrixWebhook:
    ...
    async def test_emit_webhook_success(self, test_agent_id, mock_http_session):
        ...
        result = await agent_service.emit_matrix_webhook(
            agent_id=test_agent_id, new_run_id="run-12345", tool_names=["tool1", "tool2"], query="test query"
        )
    ...
    async def test_emit_webhook_no_url(self, test_agent_id, mock_http_session):
        ...
        result = await agent_service.emit_matrix_webhook(agent_id=test_agent_id, new_run_id="run-12345")
...
class TestAgentServiceIntegration:
    ...
    async def test_send_trigger_calls_emit_webhook(self, test_agent_id, mock_http_session):
        ...
        mock_msg_response.json = AsyncMock(return_value={"messages": [{"run_id": "run-12345"}]})
        ...
        await agent_service.send_trigger_message(test_agent_id, ["tool1", "tool2"], "test query")
