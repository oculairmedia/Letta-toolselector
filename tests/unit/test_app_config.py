...
class TestLettaConfig:
    ...
    def test_message_base_urls(self):
        ...
        config = LettaConfig(url="http://main:8283", direct_message_url="http://direct:8283")
...
class TestLoadConfigFromEnv:
    ...
    def test_loads_letta_config_from_env(self):
        ...
        env = {"LETTA_API_URL": "http://test:8283/v1", "LETTA_PASSWORD": "test-key", "USE_LETTA_SDK": "true"}
    ...
    def test_loads_weaviate_config_from_env(self):
        ...
        env = {"WEAVIATE_HTTP_HOST": "custom-host", "WEAVIATE_HTTP_PORT": "9999", "WEAVIATE_GRPC_PORT": "50052"}
    ...
    def test_loads_reranker_config_from_env(self):
        ...
        env = {"ENABLE_RERANKING": "false", "RERANKER_PROVIDER": "ollama", "RERANKER_TIMEOUT": "60.0"}
    ...
    def test_protected_tools_alias(self):
        ...
        env = {"PROTECTED_TOOLS": "protected1,protected2"}
