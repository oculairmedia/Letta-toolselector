...
def sample_bm25_params():
    ...
    return [
        {"parameter_type": "k1", "value": 1.5, "description": "Custom k1 value"},
        {"parameter_type": "b", "value": 0.8, "description": "Custom b value"},
    ]
...
def sample_vector_params():
    ...
    return [
        ...
        {"parameter_type": "certainty", "value": 0.7, "description": "Minimum certainty threshold"},
    ]
...
def base_weaviate_config():
    ...
    return {"collection": "Tool", "limit": 10, "offset": 0}
...
class TestBM25Override:
    ...
    def test_bm25_override_defaults(self):
        ...
        override = BM25Override(parameter_type=BM25ParameterType.B, value=0.75, description="Test")
...
class TestSearchParameterSet:
    ...
    def test_parameter_set_creation(self):
        ...
        bm25_overrides = [BM25Override(BM25ParameterType.K1, 1.5, "Test k1")]
        vector_overrides = [VectorDistanceOverride(VectorParameterType.CERTAINTY, 0.7, "Test certainty")]
...
class TestBM25OverrideCreation:
    ...
    def test_create_valid_bm25_override(self, override_service):
        ...
        param_data = {"parameter_type": "k1", "value": 1.5, "description": "Custom k1"}
    ...
    def test_create_bm25_override_invalid_type(self, override_service):
        ...
        param_data = {"parameter_type": "invalid_param", "value": 1.5}
...
class TestVectorOverrideCreation:
    ...
    def test_create_valid_vector_override(self, override_service):
        ...
        param_data = {"parameter_type": "distance_metric", "value": "cosine", "description": "Cosine similarity"}
    ...
    def test_create_vector_override_invalid_type(self, override_service):
        ...
        param_data = {"parameter_type": "invalid_param", "value": "cosine"}
    ...
    def test_create_vector_override_invalid_value(self, override_service):
        ...
        param_data = {"parameter_type": "distance_metric", "value": "invalid_metric"}
...
class TestParameterSetCreation:
    ...
    def test_create_parameter_set_basic(self, override_service, sample_bm25_params):
        ...
        param_id = override_service.create_parameter_set(
            name="Test Set", description="Test parameter set", bm25_params=sample_bm25_params
        )
    ...
    def test_create_parameter_set_with_vector(self, override_service, sample_vector_params):
        ...
        param_id = override_service.create_parameter_set(
            name="Vector Test", description="Test with vector params", vector_params=sample_vector_params
        )
    ...
    def test_create_parameter_set_invalid_alpha(self, override_service):
        ...
        with pytest.raises(ValueError, match="Hybrid alpha must be between"):
            override_service.create_parameter_set(name="Invalid Alpha", description="Test", hybrid_alpha=1.5)
    ...
    def test_create_parameter_set_with_metadata(self, override_service):
        ...
        param_id = override_service.create_parameter_set(
            name="Meta Test", description="Test with metadata", metadata=metadata
        )
    ...
    def test_create_parameter_set_updates_statistics(self, override_service):
        ...
        override_service.create_parameter_set(name="Stats Test", description="Test statistics update")
...
class TestParameterSetApplication:
    ...
    def test_apply_bm25_overrides(self, override_service, sample_bm25_params, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="BM25 Test", description="Test BM25 application", bm25_params=sample_bm25_params
        )
    ...
    def test_apply_vector_overrides(self, override_service, sample_vector_params, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="Vector Test", description="Test vector application", vector_params=sample_vector_params
        )
    ...
    def test_apply_hybrid_config(self, override_service, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="Hybrid Test", description="Test hybrid application", hybrid_alpha=0.8, fusion_type="ranked_fusion"
        )
    ...
    def test_apply_doesnt_modify_original(self, override_service, sample_bm25_params, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="Immutable Test", description="Test immutability", bm25_params=sample_bm25_params
        )
    ...
    def test_apply_inactive_parameter_set(self, override_service, sample_bm25_params, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="Inactive Test", description="Test inactive application", bm25_params=sample_bm25_params
        )
    ...
    def test_apply_updates_statistics(self, override_service, sample_bm25_params, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="Stats Test", description="Test statistics update", bm25_params=sample_bm25_params
        )
...
class TestParameterSetManagement:
    ...
    def test_get_parameter_set(self, override_service, sample_bm25_params):
        ...
        param_id = override_service.create_parameter_set(
            name="Get Test", description="Test getting", bm25_params=sample_bm25_params
        )
    ...
    def test_list_parameter_sets(self, override_service, sample_bm25_params):
        ...
        override_service.create_parameter_set(name="Set 1", description="First set", bm25_params=sample_bm25_params)
        override_service.create_parameter_set(name="Set 2", description="Second set", bm25_params=sample_bm25_params)
    ...
    def test_list_parameter_sets_active_only(self, override_service, sample_bm25_params):
        ...
        param_id = override_service.create_parameter_set(
            name="Active Test", description="Test active filtering", bm25_params=sample_bm25_params
        )
    ...
    def test_delete_parameter_set(self, override_service, sample_bm25_params):
        ...
        param_id = override_service.create_parameter_set(
            name="Delete Test", description="Test deletion", bm25_params=sample_bm25_params
        )
...
class TestSchemaAndInfo:
    ...
    def test_get_statistics(self, override_service, sample_bm25_params, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="Stats Test", description="Test statistics", bm25_params=sample_bm25_params
        )
        override_service.apply_parameter_set(param_id, base_weaviate_config)
...
class TestStatisticsTracking:
    ...
    def test_track_bm25_usage(self, override_service, sample_bm25_params, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="Usage Test", description="Test usage tracking", bm25_params=sample_bm25_params
        )
    ...
    def test_track_distance_metric_usage(self, override_service, sample_vector_params, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="Metric Test", description="Test metric tracking", vector_params=sample_vector_params
        )
...
class TestEdgeCases:
    ...
    def test_empty_parameter_set(self, override_service):
        ...
        param_id = override_service.create_parameter_set(name="Empty Set", description="Set with no parameters")
    ...
    def test_disabled_override_not_applied(self, override_service, base_weaviate_config):
        ...
        param_id = override_service.create_parameter_set(
            name="Disabled Test", description="Test disabled overrides", bm25_params=bm25_params
        )
    ...
    def test_partial_invalid_params_skipped(self, override_service):
        ...
        param_id = override_service.create_parameter_set(
            name="Mixed Test", description="Test mixed valid/invalid params", bm25_params=mixed_params
        )
