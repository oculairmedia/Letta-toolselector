...
class TestValidationResult:
    ...
    def test_create_validation_result(self):
        ...
        result = ValidationResult(
            field="test.field", level=ValidationLevel.ERROR, message="Test error message", suggestion="Fix it this way"
        )
...
class TestConfigValidationResponse:
    ...
    def test_create_validation_response(self):
        ...
        errors = [ValidationResult("field1", ValidationLevel.ERROR, "Error 1")]
        warnings = [ValidationResult("field2", ValidationLevel.WARNING, "Warning 1")]
        suggestions = [ValidationResult("field3", ValidationLevel.INFO, "Suggestion 1")]

        response = ConfigValidationResponse(valid=False, errors=errors, warnings=warnings, suggestions=suggestions)
...
class TestSimpleConfigurationValidator:
    ...
    def test_validate_embedding_config_valid(self, validator):
        ...
        embedding_config = {"provider": "ollama", "dimension": 1536, "max_tokens": 8192}
    ...
    def test_validate_embedding_config_invalid_provider(self, validator):
        ...
        embedding_config = {"provider": "invalid_provider", "dimension": 1536}
    ...
    def test_validate_embedding_config_missing_provider(self, validator):
        ...
        embedding_config = {"dimension": 1536}
    ...
    def test_validate_weaviate_config_valid(self, validator):
        ...
        weaviate_config = {"hybrid": {"alpha": 0.75}}
    ...
    def test_validate_reranker_config_valid(self, validator):
        ...
        reranker_config = {"enabled": True, "type": "cross-encoder", "scoring": {"top_k": 10}}
    ...
    def test_validate_reranker_config_invalid_type(self, validator):
        ...
        reranker_config = {"enabled": True, "type": "invalid_type"}
    ...
    def test_estimate_configuration_cost_openai(self, validator):
        ...
        config = {
            "search": {"embedding": {"provider": "openai", "model": "text-embedding-3-small", "max_tokens": 8192}}
        }
    ...
    def test_estimate_configuration_cost_ollama(self, validator):
        ...
        config = {"search": {"embedding": {"provider": "ollama", "model": "test-model"}}}
    ...
    def test_assess_performance_impact_low(self, validator):
        ...
        config = {"search": {"embedding": {"dimension": 1536}}, "reranker": {"enabled": False}}
