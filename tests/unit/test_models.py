...
class TestToolModel:
    ...
    def test_tool_is_letta_core_by_name(self):
        ...
        core_names = ["send_message", "conversation_search", "archival_memory_insert", "archival_memory_search"]
    ...
    def test_tool_allows_extra_fields(self):
        ...
        tool = Tool(name="test", custom_field="custom_value", another_field=123)
...
class TestSearchResultModel:
    ...
    def test_search_result_creation(self):
        ...
        result = SearchResult(name="web_search", description="Search the web", score=95.5, distance=0.045)
    ...
    def test_effective_score_prefers_rerank(self):
        ...
        result = SearchResult(name="test", rerank_score=98.0, score=85.0, distance=0.15)
    ...
    def test_effective_score_uses_score_when_no_rerank(self):
        ...
        result = SearchResult(name="test", score=85.0, distance=0.15)
...
class TestToolLimitsConfig:
    ...
    def test_tool_limits_config_protected_tools_alias(self):
        ...
        with patch.dict("os.environ", {"PROTECTED_TOOLS": "my_protected_tool"}, clear=False):
...
class TestUtilityFunctions:
    ...
    def test_dict_to_tool(self):
        ...
        data = {"id": "tool-123", "name": "web_search", "tool_type": "external_mcp"}
    ...
    def test_dict_to_search_result(self):
        ...
        data = {"name": "web_search", "score": 95.0, "distance": 0.05}
