...
class TestProtectedToolsLogic:
    ...
    def test_protection_prevents_all_detachments(self, sample_tools):
        ...
        tools_to_detach = [tool for tool in sample_tools if tool["id"] not in protected_ids]
    ...
    def test_empty_protection_lists(self, sample_tools):
        ...
        detachable_mcp_tools = [
            tool for tool in sample_tools if tool.get("tool_type") == "external_mcp" and tool["id"] not in protected_ids
        ]
