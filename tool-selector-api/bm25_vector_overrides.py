...
class BM25VectorOverrideService:
    ...
    def __init__(self):
        ...
        self.parameter_sets = {}
        self.active_overrides = {"bm25": {}, "vector": {}, "hybrid": {}}
    ...
    def create_parameter_set(
        ...
        logger.info(
            f"Created parameter set: {name} ({parameter_set_id}) with "
    ...
    def apply_parameter_set(self, parameter_set_id: str, base_config: Dict[str, Any]) -> Dict[str, Any]:
        ...
        logger.info(
            f"Applied parameter set {parameter_set_id} with "
    ...
    def get_bm25_parameter_schema(self) -> Dict[str, Any]:
        ...
        return {param_type.value: schema for param_type, schema in self.bm25_schemas.items()}

    def get_vector_parameter_schema(self) -> Dict[str, Any]:
        """Get vector parameter validation schema"""
        return {param_type.value: schema for param_type, schema in self.vector_schemas.items()}
