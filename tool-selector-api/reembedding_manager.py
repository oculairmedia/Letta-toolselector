...
def main():
    ...
    parser = argparse.ArgumentParser(description="Re-embedding Manager - Manage batch tool re-embedding operations")
    ...
    status_parser.add_argument(
        "--checkpoint-file", default="reembedding_checkpoint.json", help="Checkpoint file to check"
    )
