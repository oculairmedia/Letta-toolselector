        ...
        return jsonify(
            {
                ...
                "data": {
                    ...
                    "alert_summary": {"total_alerts_24h": alert_count, "critical_alerts_24h": critical_alerts},
...
async def get_cost_summary():
    ...
    try:
        ...
        return jsonify({"success": True, "data": summary.to_dict()})
...
async def get_budget_limits():
    ...
    try:
        ...
        return jsonify({"success": True, "data": budget_status})
...
async def set_budget_limit():
    ...
    try:
        ...
        try:
            ...
            return jsonify({"success": False, "error": "Invalid limit value. Must be a non-negative number."}), 400
...
async def remove_budget_limit():
    ...
    try:
        ...
        if removed:
            ...
            return jsonify({"success": False, "error": "Budget limit not found"}), 404
...
async def get_cost_alerts():
    ...
    try:
        ...
        return jsonify(
            {"success": True, "data": {"alerts": alert_data, "count": len(alert_data), "hours_requested": hours}}
        )
...
async def record_manual_cost():
    ...
    try:
        ...
        try:
            ...
            return jsonify({"success": False, "error": "Invalid cost value. Must be a non-negative number."}), 400

        manager = _get_cost_manager()

        # Record the cost
        allowed = await manager.record_cost(
            category=category, operation=data["operation"], cost=cost, metadata=data.get("metadata", {})
        )
        ...
        return jsonify(
            {
                ...
                "data": {
                    ...
                    if allowed
                    else "Cost recorded but operation would be blocked by hard limits",
                },
            }
        )
...
async def estimate_operation_cost():
    ...
    try:
        ...
        if "operation_type" not in data:
            return jsonify({"success": False, "error": "Missing required field: operation_type"}), 400
