...
async def register_reranker_model():
    ...
    try:
        ...
        return jsonify({"success": True, "data": new_model, "message": f"Model {data['id']} registered successfully"})
...
async def update_registered_model(model_id):
    ...
    try:
        ...
        return jsonify({"success": True, "data": model_to_update, "message": f"Model {model_id} updated successfully"})
...
async def test_registered_model(model_id):
    ...
    try:
        ...
        return jsonify({"success": True, "data": test_results, "message": f"Model {model_id} test completed"})
...
async def unregister_reranker_model(model_id):
    ...
    try:
        ...
        return jsonify({"success": True, "message": f"Model {model_id} unregistered successfully"})
