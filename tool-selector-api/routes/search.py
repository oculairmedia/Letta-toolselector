...
async def get_supported_distance_metrics():
    ...
    try:
        ...
        return jsonify({"supported_distance_metrics": metrics, "count": len(metrics), "default_metric": "cosine"})
...
async def create_search_parameter_set():
    ...
    try:
        ...
        return jsonify(
            {"parameter_set_id": parameter_set_id, "name": name, "description": description, "created": True}
        )
...
async def list_search_parameter_sets():
    ...
    try:
        ...
        return jsonify(
            {"parameter_sets": parameter_sets, "total_count": len(parameter_sets), "active_only": active_only}
        )
...
async def get_search_override_statistics():
    ...
    try:
        ...
        return jsonify({"service_statistics": statistics, "timestamp": time.time()})
