    ...
    try:
        ...
        for i, test_case in enumerate(test_cases, 1):
            ...
            for j, obj in enumerate(response.objects, 1):
                ...
                is_expected = any(
                    expected in tool_name.lower() for expected in [exp.lower() for exp in test_case["expected_tools"]]
                )
        ...
        if overall_accuracy:
            ...
            enhanced_tools = sum(1 for obj in all_tools_response.objects if obj.properties.get("enhanced_description"))
